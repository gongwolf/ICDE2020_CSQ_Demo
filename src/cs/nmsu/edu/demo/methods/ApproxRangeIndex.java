...
import cs.nmsu.edu.demo.methods.myNodePriorityQueue;
import cs.nmsu.edu.demo.methods.path;
...
public class ApproxRangeIndex {
	...
	public ApproxRangeIndex(String city, double distance_threshold, QueryParameters qp) {
		...
		if (qp.type == null || qp.type.equals("")) {
			...
			this.treePath = constants.data_path + "/real_tree_" + city + "_" + qp.type + ".rtr";
			this.dataPath = constants.data_path + "/staticNode_real_" + city + "_" + qp.type + ".txt";
